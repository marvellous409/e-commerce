  ...
  return (
     <div className="max-w-7xl mx-auto  mt-10 items-center justify-center  overflow-hidden">
      ...
      <div className=" mt-5 grid grid-cols-1 md:grid-cols-3 gap-6">
         <img className="w-96 rounded-2xl" src={Images1} alt="clothes" />
         <img className="w-96 rounded-2xl" src={Images2} alt="human" />
         <img className="w-96 h-63 rounded-2xl " src={Images3} alt="fair" />
      </div>
     </div>
  );
};
